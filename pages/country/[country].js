  ...
  return (
    <div className={styles.container}>
      <Head>
        ...
        <meta
          property="og:image"
          content={`https://flagcdn.com/w1280/${props.country.emoji.toLowerCase()}.png`}
        />
      ...
      <main className={styles.main}>
        <div className={styles.grid}>
          ...
          <div className={styles.card}>
            ...
            <h3>Overall democracy score, recorded in 2021.</h3>
          </div>
          {props.country.diff != 0 ? (
            <div className={styles.card}>
              ...
              <h3>
                ...
                from when last recorded in 2020.
              </h3>
            </div>
          ) : (
            <div className={styles.card}>
              ...
              <h3>change in score from when last recorded in 2020.</h3>
            </div>
          )}
          <div className={styles.cardFull + " " + styles.card}>
