...
export default function Home(props) {
  return (
    <div className={styles.container}>
      <Head>
        <title>Latin America - The State of Democracy</title>
      ...
      >
        ...
        <h1 className={styles.title}>
          <span className={styles.titleUnderline}>Latin America</span>
        </h1>
      </article>
...
export const getServerSideProps = async () => {
  const countries = await fetch(
    ...
    .then((countries) => filter(countries, country => country.region === 'Latin America'));
